...
export default function Benchmarks() {
  return <Layout title="Benchmark：读懂评测" description="从考察能力、指标和真实任务样例理解经典 Benchmark，首篇深入 τ-bench 的 Agent 交互与可靠性。">
    <main className="papers-page benchmark-page">
      <header className="papers-intro"><span className="eyebrow">UNDERSTAND THE EVALUATION</span><h1>Benchmark</h1><p>分数背后，模型究竟完成了什么？</p><div className="benchmark-lenses"><span>01 / 考察能力</span><span>02 / 评测指标</span><span>03 / 数据集与题型</span></div></header>
